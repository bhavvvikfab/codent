  ...
  <main id="main" class="main">
    <div class="pagetitle">
      ...
      <div class="col-xxl-12 col-lg-12 col-md-12 col-sm-12">
        <h1>Dental practice Details</h1>
        <nav>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= base_url('dashboard') ?>">Dashboard</a></li>
            <li class="breadcrumb-item active">Dental practice Details</li>
          </ol>
        </nav>
      </div>
    </div>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
             ...
             <div class="card-header">
               <div class="row">
                  <div class="col-lg-8">
                      <h5 class="card-title text-start">View Dental practice Details</h5>
                  </div>
                  <div class="col-lg-4">
            ...
            <form class="m-3">
              <div class="row">
                ...
                <div class="text-center mb-3">
                  ...
                  <label class="form-label" for="inputNanme4"> <h5><b>Dental practice Image: </b></h5>
                  </label><br> 
                ...
                <div class="col-lg-8 d-lg-flex flex-lg-column justify-content-lg-center">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 pb-2 pb-lg-0">
                      ...
                      <label class="form-label" for="inputNanme05"> <b> Dental practice Name :</b> </label> 
                      <?= isset($hospital['fullname']) ? $hospital['fullname'] : 'N/A' ?>
                     </div>
                       
                    <div class="col-lg-6 col-md-6 col-sm-12 pb-2 pb-lg-0"><i class="bi bi-person-circle" aria-hidden="true"></i>
                      <label class="form-label" for="inputdate"> <b>Role :</b> Dental practice
                    </label> 
                     </div>
                  </div>
              <hr>
              <div class="row">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 pb-2 pb-lg-0">
                    <i class="bi bi-envelope-fill" aria-hidden="true"></i> <label class="form-label" for=""> <b>  Email :</b></label> <?= isset($hospital['email']) ? $hospital['email'] : 'N/A' ?>   
                   </div>
                   ...
                   <div class="col-lg-6 col-md-6 col-sm-12 pb-2 pb-lg-0"><i class="bi bi-telephone-fill" aria-hidden="true"></i>
                        ...
                        <?= isset($hospital['phone']) ? $hospital['phone'] : 'N/A' ?>
                        </label>
                     </div>
              ...
              <div class="row">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 pb-2 pb-lg-0">
                    <i class="bi bi-list-ul" aria-hidden="true"></i> <label class="form-label" for=""> <b>About : </b></label> 
                    <?= isset($hospital_data['note']) ? $hospital_data['note'] : 'N/A' ?>
                  ...
                  </label> <?= isset($hospital['address']) ? $hospital['address'] : 'N/A' ?>
                </div>
              ...
              <div class="row">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 pb-2 pb-lg-0">
                    <i class="bi bi-alarm" aria-hidden="true"></i> <label class="form-label" for=""> <b>Plan duration : </b></label> <?= isset($package[0]['duration']) ? $package[0]['duration'] : 'N/A' ?> Days
                   </div>
                   
                    <div class="col-lg-6 col-md-6 col-sm-12 pb-2 pb-lg-0">
                    <i class="bi bi-asterisk" aria-hidden="true"></i> <label class="form-label" for=""> <b>Current Plan : </b></label> <?= isset($package[0]['plan_name']) ? $package[0]['plan_name'] : 'N/A' ?> 
                   </div>
             ...
             <div class="row">
                   ...
                   <div class="col-lg-12 col-md-12 col-sm-12 pb-2 pb-lg-0">
                    <i class="bi bi-ticket-detailed-fill" aria-hidden="true"></i> <label class="form-label" for=""> <b>Plan-Details : </b>  <?= isset($package[0]['details']) ? $package[0]['details'] : 'N/A' ?></label>  
                   </div>
