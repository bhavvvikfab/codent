            ...
            alt="Profile Image">
                  ...
                  <div class="col-lg-8 d-lg-flex flex-lg-column justify-content-lg-center">
                    ...
                    <h4><b>Appointment Details : </b></h4>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-12 pb-2 pb-lg-0">
                        <i class="bi bi-clipboard2-fill"></i> <label class="form-label" for="">
                          <b> Status : </b></label>
                       
                        <?php
                            $status = isset($appointment['appointment_status']) ? $appointment['appointment_status'] : ' ';
                            $textColor = '';
                            ...
                            ?>
                            <span class="<?= $textColor ?> fw-bold"><?= isset($appointment['appointment_status']) ? $appointment['appointment_status'] : ' '; ?></span>


                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 pb-2 pb-lg-0">
                        <i class="bi bi-clock-fill"></i> <label class="form-label" for="">
                          <b>Appointment Slot : </b></label>
                        <?= isset($appointment['schedule']) ? $appointment['schedule'] : 'N/A'; ?>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 pb-2 pb-lg-0">
                        <i class="bi bi-person-circle"></i> <label class="form-label" for="">
                          <b>Dr. Name  : </b></label>
                        <?= isset($appointment['doctor_name']) ? $appointment['doctor_name'] : 'N/A'; ?>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 pb-2 pb-lg-0">
                        <i class="bi bi-info-circle-fill"></i> <label class="form-label" for="">
                          <b>Appointment About : </b></label>
                        <?= isset($appointment['note_for_team']) ? $appointment['note_for_team'] : 'N/A'; ?>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 pb-2 pb-lg-0">
                        <i class="bi bi-currency-dollar"></i> <label class="form-label" for="">
                          <b>Method : </b></label>
                        <?= isset($appointment['method']) ? $appointment['method'] : 'N/A'; ?>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 pb-2 pb-lg-0">
                        <i class="bi bi-bookmark-fill"></i> <label class="form-label" for="">
                          <b>Instruction For Lead : </b></label>
                        <?= isset($appointment['instruction_for_lead']) ? $appointment['instruction_for_lead'] : 'N/A'; ?>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 pb-2 pb-lg-0">
                        <i class="bi bi-telephone-fill"></i> <label class="form-label" for="">
                          <b>Contacted Via : </b></label>
                        <?= isset($appointment['contacted_via']) ? $appointment['contacted_via'] : 'N/A'; ?>
                    </div>
                    
                    <div class="col-lg-6 col-md-6 col-sm-12 pb-2 pb-lg-0">
                        <i class="bi bi-person-fill"></i> <label class="form-label" for="">
