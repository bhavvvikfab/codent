            ...
            <form class="m-3">
              <div class="row">
                ...
                <div class="col-lg-4 pb-2 pb-lg-0">
                  ...
                  <label class="form-label" for="inputNanme4"> <h5><b> Patient Image: </b><?= esc($appointment['id']) ?></h5>
                ...
                <div class="col-lg-8 d-lg-flex flex-lg-column justify-content-lg-center">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 pb-2 pb-lg-0">
                      ...
                      <label class="form-label" for="inputNanme05"> <b> Enquiry:</b> <?= esc($appointment['patient_name']) ?></label>   
                     </div>
                       
                    <div class="col-lg-6 col-md-6 col-sm-12 pb-2 pb-lg-0"><i class="bi bi-calendar-week-fill" aria-hidden="true"></i>
                      <label class="form-label" for="inputdate"> <b> Birth Date</b> <?= esc($appointment['schedule']) ?>
                    </label> 
                     </div>
                  </div>
              <hr>
              ...
              <div class="row">
                  ...
                  </label> <?= esc($appointment['doctor_name']) ?>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 pb-2 pb-lg-0"><i class="bi bi-file-earmark-medical-fill" aria-hidden="true"></i>
                  ...
                  </label> <?= esc($appointment['lead_instruction']) ?>
                </div>
