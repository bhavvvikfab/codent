...
$routes->group('hospital', ['filter' => $authFilter], function ($routes) {
    ...
    $routes->post('add_lead_details', 'Leads\LeadsController::add_lead_details');   
    ...
    $routes->post('confirm_appointment', 'appointment\AppointmentController::confirm_appointment');
...
//==========================user role receptionist [4]========================
$routes->group('receptionist', ['filter' => $authFilter], function ($routes) {
    $routes->get('dashboard', 'UserController::dashboard');

    //log in and subscription update
    $routes->get('users_profile', 'UserController::index');
    $routes->get('profile', 'UserController::showProfile');
    $routes->post('profile_update', 'UserController::update_profile');
    $routes->post('update_password', 'UserController::change_password');
