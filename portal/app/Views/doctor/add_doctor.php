...
<main id="main" class="main">
    <div class="pagetitle">
      ...
      <div class="col-xxl-12 col-lg-12 col-md-12 col-sm-12">
        ...
        <nav>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= base_url().''.session('prefix').'/'.'doctor'?>">All Doctor</a></li>
                  ...
                  <div class="col-lg-8">
                   ...
                   <div class="col-lg-4">
                      <h5 class="card-title text-end addsup">
                          <a href="<?= base_url().''.session('prefix').'/'.'doctor'?>"> Back </a></h5>
                  </div>
                </div>
             </div>
            <div class="card-body">
              ...
              <form id="doctor_form" enctype="multipart/form-data" action="<?= base_url().''.session('prefix').'/'.'doctor_register'?>"  method="post" >
                            <div class="row">
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <?php if (session('errors.specialist')): ?>
                                        <small class="text-danger"><?= esc(session('errors.specialist')) ?><i class="bi bi-exclamation-circle"></i></small>
                                    <?php endif; ?>
                                </div>
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <?php if (session('errors.qualification')): ?>
                                        <small class="text-danger"><?= esc(session('errors.qualification')) ?><i class="bi bi-exclamation-circle"></i></small>
                                    <?php endif; ?>
                                </div>
                            ...
                            <div class="col-lg-6 mb-3">
                                    ...
                                    <?php if (session('errors.schedule')): ?>
                                        <small class="text-danger"><?= esc(session('errors.schedule')) ?><i class="bi bi-exclamation-circle"></i></small>
                                    <?php endif; ?>
                                  </div>

                                <div class="col-lg-6 mb-3">
                                  <label for="about" class="form-label"><i class="bi bi-person-fill" style="font-size: 18px;"></i> About</label>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <?php if (session('errors.specialistOrPractice')): ?>
                                        <small class="text-danger"><?= esc(session('errors.specialistOrPractice')) ?><i class="bi bi-exclamation-circle"></i></small>
                                    <?php endif; ?>
                                </div>
