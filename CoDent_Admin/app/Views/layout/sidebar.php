...
<aside id="sidebar" class="sidebar">
 ...
 -->
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" data-bs-target="#order-nav" data-bs-toggle="collapse" href="123">
        <i class="bi bi-cash"></i><span>Subscription</span><i class="bi bi-chevron-down ms-auto"></i>
      </a>
      <ul id="order-nav" class="nav-content collapse " data-bs-parent="#order-nav">
        ...
        <li>
          <a href="addsubscription.php">
            <i class="bi bi-circle"></i><span>Add New Subscription</span>
          </a>
        </li>
      </ul>
    </li>
